...
def get_bottom_up_paths(job_dag):
    ...
    for depth in range(args.max_depth):
        ...
        #print("Msg Mat", np.mat([sp_mat.get_row(), sp_mat.get_col()]))
        #print("Msg Mask", msg_masks[depth,:])
    ...
    for _ in range(depth, args.max_depth):
        ...
        #print("EMPTY HERE ", depth, msg_mats[-1].get_data())
