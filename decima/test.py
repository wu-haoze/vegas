...
for scheme in args.test_schemes:
    if scheme == 'learn':
        sess = tf.Session()
        #print("NODE ", args.node_input_dim, args.job_input_dim, args.hid_dims, args.output_dim, args.max_depth, args.exec_cap, sess)
...
for exp in range(args.num_exp):
    ...
    for scheme in args.test_schemes:
        ...
        # load an agent
        agent = agents[scheme]
        #print("ENVIRONMENT ", env,args.num_ep)
        # start experiment
        obs = env.observe()
        #print("OBS ", obs)
