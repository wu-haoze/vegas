...
# -- Basic --
parser.add_argument('--repeat-job', type=int, default=-1,
                    help='Job to repeat')
parser.add_argument('--dump-query-file', type=str, default=None,
                    help='Just dump the 1-query file')
parser.add_argument('--property-file', type=str, default=None,
                    help='Property file for multi-step verification')
parser.add_argument('--backward', action='store_true',
                    help='Use backward bound tightening')
parser.add_argument('--abstraction', action='store_true',
                    help='Use abstraction')
parser.add_argument('--use-benchmark', action='store_true',
                    help='Use benchmark')
parser.add_argument('--proof-transfer', action='store_true',
                    help='Grow the proof transfer graph')
...
parser.add_argument('--trial', type=int, default=0,
                    help='trial number of the benchmark run')
...
# -- Attack --
parser.add_argument('--attack_n_jobs', type=int, default=5)
parser.add_argument('--attack_n_execs', type=int, default=5)
parser.add_argument('--attack_repetition', type=int, default=0)

# -- Environment --
parser.add_argument('--exec_cap', type=int, default=100,
                    help='Number of total executors (default: 2,5,10)')
parser.add_argument('--num_init_dags', type=int, default=10,
                    help='Number of initial DAGs in system (default: 5,10,20)')
parser.add_argument('--rep', type=int, default=0,
                    help='repetition number of the benchmark [0-24]')
parser.add_argument('--num_stream_dags', type=int, default=0,
                    help='number of streaming DAGs (default: 0)')
...
# -- Visualization --
parser.add_argument('--canvs_visualization', type=int, default=0,
                    help='Enable canvs visualization (default: 0)')
